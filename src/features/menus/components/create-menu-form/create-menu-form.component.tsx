...
import { useCreateMenuForm } from "./use-create-menu-form.hook";

export function CreateMenuForm({ restaurantSlug }: { restaurantSlug: string }) {
  const { t, form, isLoading, submitHandler } =
    useCreateMenuForm(restaurantSlug);
