...
import {
  ...
  useRestaurantForm,
} from "../restaurant-form/use-restaurant-form.hook";
...
export function RestaurantForm(props: RestaurantFormProps) {
    ...
    props.mode === "create"
      ...
      : [
          "update",
          {
            formInitialValues: {
              ...props.initialValues,
              tags: props.initialValues.tags.map((tagId) => tagId.toString()),
            },
            extraInitialValues: {
              coverImgUrl: props.initialValues.coverImgUrl,
            },
  ...
  const {
    ...
    ...(useRestauranFormParams as Parameters<typeof useRestaurantForm>),
  );
